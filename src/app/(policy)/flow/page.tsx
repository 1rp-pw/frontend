...
export default function FlowBuilder() {
  ...
  return (
    <div className="w-full h-[80vh] border rounded-lg" ref={reactFlowWrapper}>
      <ReactFlow
        nodes={nodes}
        edges={edges}
      ...
      >
        ...
        <Panel position="top-right">
          <div className="flex gap-2">
            <Button onClick={addInputNode} variant="outline" size="sm" className={"cursor-pointer"}>
              <Plus className="mr-2 h-4 w-4" /> Add Input
            </Button>
            <Button onClick={saveFlow} variant="outline" size="sm" className={"cursor-pointer"}>
              <Save className="mr-2 h-4 w-4" /> Save
            </Button>
            <Button onClick={runFlow} variant="default" size="sm" className={"cursor-pointer"}>
