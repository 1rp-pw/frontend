...
export function PublishFlow() {
  ...
  const {tests, saveFlow, id, updateFlowSpec} = useFlowStore()
  ...
  const allTestsPassed = createdTests.length > 0 && createdTests.every((test) => test.result?.result === test.expectedOutcome)
