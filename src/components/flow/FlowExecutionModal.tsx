...
export function FlowExecutionModal({
	...
	if (
		!executionData ||
		!executionData.nodeResponse ||
		executionData.nodeResponse.length === 0
	) {
		return null;
	}

	const testPassed = executionData.result === expectedOutcome;
	const nodeResponses = executionData.nodeResponse;
				...
				<div className="flex h-[65vh] min-h-[500px] gap-4">
										...
										>
											...
											<div className="text-muted-foreground text-sm">
												<div className="truncate">
													<strong>Result:</strong> {String(nodeResult || "N/A")}
												</div>
												{hasError && (
					...
					<div className="flex-1">
						<Tabs defaultValue="details" className="h-full">
							...
							<TabsContent value="details" className="mt-4 h-[calc(100%-3rem)]">
								{selectedNode && (
							...
							<TabsContent value="trace" className="mt-4 h-[calc(100%-3rem)]">
								<ScrollArea className="h-full">
													...
													return (
														...
														>
															<div className="mb-3 flex items-center gap-2">
																...
																<Badge
																	variant={
																		execution.result ? "default" : "destructive"
																	}
																>
							...
							<TabsContent value="rule" className="mt-4 h-[calc(100%-3rem)]">
